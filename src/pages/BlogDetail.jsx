                            ...
                            if (sec.type === 'image') {
                                ...
                                return (
                                    <div key={idx} style={{
                                        ...
                                        {sec.caption && (
                                            <div style={{ textAlign: 'center', fontFamily: 'var(--font-hand)', marginTop: '0.5rem', opacity: 0.6 }}>
                                                {sec.caption}
                                            </div>
                                        )}
                                    </div>
                                        ...
                                        {sec.images.map((img, i) => {
                                            ...
                                            return (
                                                <div key={i} style={{
                                                    ...
                                                    {img.caption && (
                                                        <div style={{ textAlign: 'center', fontFamily: 'var(--font-hand)', marginTop: '0.3rem', fontSize: '0.8rem', opacity: 0.6 }}>
                                                            {img.caption}
                                                        </div>
                                                    )}
                                                </div>
